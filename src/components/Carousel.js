...
const Carousel = () => {
  ...
  return (
    <div className="max-w-[1240px] mx-auto px-4 py-16 relative flex justify-center items-center">
        <BsArrowLeftSquareFill className="absolute top-[50%] text-3xl text-white cursor-pointer left-8"/>
        <BsArrowRightSquareFill className="absolute top-[50%] text-3xl text-white cursor-pointer right-8"/>
